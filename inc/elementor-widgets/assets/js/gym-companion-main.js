(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".gym-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".gym-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.gym-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.gym-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.gym-subscribe-newsletter-area');
    if ($subscribe.length) {
