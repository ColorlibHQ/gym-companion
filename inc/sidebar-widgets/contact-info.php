...
class gym_contactinfo_widget extends WP_Widget {
...
'gym_contactinfo_widget', 


// Widget name will appear in UI
esc_html__( '[ Gym ] Contact Info', 'gym-companion' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer contact info', 'gym-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Contact Info', 'gym-companion' );
}
...
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'addressicon' ) ); ?>"><?php _e( 'Icon', 'gym-companion' ); ?>:</label>
    <div class="gym-media-container">
        <div class="gym-media-inner">
            ...
            <span class="gym-no-image" id="<?php echo wp_kses_post( $this->get_field_id( 'addressicon' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'gym-companion' ); ?></span>
        </div>
    
    <input type="text" id="<?php echo wp_kses_post( $this->get_field_id( 'addressicon' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'addressicon' ) ); ?>" value="<?php echo esc_attr( $addressicon ); ?>" class="gym-media-url" />

    <input type="button" value="<?php echo _e( 'Remove', 'gym-companion' ); ?>" class="button gym-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'addressicon' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

    <?php $button_text = ( $addressicon != '' ) ? __( 'Change Image', 'gym-companion' ) : __( 'Select Image', 'gym-companion' ); ?>
    <input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button gym-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'addressicon' ) ); ?>-button" />
    <br class="clear">
    </div>
</p>
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'address' ) ); ?>"><?php esc_html_e( 'Address:' ,'gym-companion'); ?></label> 
...
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'pnumbericon' ) ); ?>"><?php _e( 'Icon', 'gym-companion' ); ?>:</label>
    <div class="gym-media-container">
        <div class="gym-media-inner">
            ...
            <span class="gym-no-image" id="<?php echo esc_attr( $this->get_field_id( 'pnumbericon' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'gym-companion' ); ?></span>
        </div>
    
    <input type="text" id="<?php echo esc_attr( $this->get_field_id( 'pnumbericon' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'pnumbericon' ) ); ?>" value="<?php echo esc_attr( $pnumbericon ); ?>" class="gym-media-url" />

    <input type="button" value="<?php echo _e( 'Remove', 'gym-companion' ); ?>" class="button gym-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'pnumbericon' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

    <?php $button_text = ( $pnumbericon != '' ) ? __( 'Change Image', 'gym-companion' ) : __( 'Select Image', 'gym-companion' ); ?>
    <input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button gym-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'pnumbericon' ) ); ?>-button" />
    <br class="clear">
    </div>
</p>
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'pnumber' ) ); ?>"><?php esc_html_e( 'Phone Number:' ,'gym-companion'); ?></label> 
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'emailicon' ) ); ?>"><?php _e( 'Icon', 'gym-companion' ); ?>:</label>
	<div class="gym-media-container">
		<div class="gym-media-inner">
			...
			<span class="gym-no-image" id="<?php echo esc_attr( $this->get_field_id( 'emailicon' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'gym-companion' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'emailicon' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'emailicon' ) ); ?>" value="<?php echo esc_attr( $emailicon ); ?>" class="gym-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'gym-companion' ); ?>" class="button gym-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'emailicon' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $emailicon != '' ) ? __( 'Change Image', 'gym-companion' ) : __( 'Select Image', 'gym-companion' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button gym-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'emailicon' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>"><?php esc_html_e( 'Email:' ,'gym-companion'); ?></label> 
...
function gym_contactinfo_load_widget() {
	register_widget( 'gym_contactinfo_widget' );
}
add_action( 'widgets_init', 'gym_contactinfo_load_widget' );