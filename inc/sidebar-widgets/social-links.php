...
class Gym_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Gym ] Social Links', 'gym-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'gym-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'gym-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'gym-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'gym-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'gym-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'gym-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'gym-companion'); ?></label>
...
} // Class gym_social_links ends here


// Register and load the widget
function gym_social_links_widget_load() {
	register_widget( 'Gym_social_links' );
}
add_action( 'widgets_init', 'gym_social_links_widget_load' );